...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/gp-connect-appointments-management-fhir/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/gp-connect-appointments-management-fhir/blob/master/CODE_OF_CONDUCT.md).
...
Telling Apigee how to connect to your backend requires a *Target Server*, which you should call named `gp-connect-appointments-management-fhir-target`.
